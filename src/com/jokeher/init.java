...
public class init {
    ...
    private static final String CREATE_PRAISE_JOKE_TABLE_SQL="CREATE TABLE praise_joke(token INTEGER PRIMARY KEY AUTO_INCREMENT,userId INTEGER NOT NULL,jokeId INTEGER NOT NULL,isFunny BOOLEAN NOT NULL)";
}
